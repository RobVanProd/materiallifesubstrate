#!/usr/bin/env python3
"""Create or verify the Authoritative Drift State Bridge outer seal."""
...
SCHEMA = "mls.authoritative-drift-state-bridge.outer-seal.v1"
...
TAG = "authoritative-drift-state-bridge-lab-evidence-v1"
...
def create(bundle: Path, source_sha: str, ci_run_id: int) -> dict[str, object]:
    ...
    required = {
        "raw-a", "raw-b", "oracle", "parent-mechanics-bridge",
    ...
    value: dict[str, object] = {
        ...
        "explicit_position_remainder_selected": False,
        "safe_domain": "2^-24",
...
def verify(bundle: Path) -> dict[str, object]:
    ...
    expected_fields = {
        ...
        "ci_run_id", "decision", "selected_path", "selected_refinement",
        "explicit_position_remainder_selected", "safe_domain", "promotion",
...
def main() -> int:
    ...
    try:
        ...
        print(f"AUTHORITATIVE DRIFT BRIDGE OUTER SEAL INVALID: {error}")
        return 1
    print(json.dumps(value, indent=2, sort_keys=True))
    print("AUTHORITATIVE DRIFT BRIDGE OUTER SEAL VALID: R=128 NO_PROMOTION")
    return 0
