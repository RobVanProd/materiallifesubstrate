...
text=(root/'.github/workflows/world-material-phase-unification-lab.yml').read_text()
new=yaml.load(text,Loader=UniqueLoader)
old=yaml.load((root/'.github/workflows/authoritative-world-mechanics-integration-lab.yml').read_text(),Loader=UniqueLoader)
...
print('Material workflow strict YAML, inherited gates and shell syntax: PASS')
