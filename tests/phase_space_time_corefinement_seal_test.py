#!/usr/bin/env python3
"""Outer-seal positive and mutation regression for co-refinement evidence."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--tool",
        type=Path,
        default=root / "tools" / "seal_phase_space_time_corefinement_evidence.py",
    )
    arguments = parser.parse_args()
    with tempfile.TemporaryDirectory(prefix="mls-corefinement-seal-") as temporary:
        ...
        value["decision"] = "retain_order_matched_space_time_corefinement_for_research"
    ...
    print("phase-space/time corefinement outer-seal regression: PASS (2 positives, 3 mutations)")
    return 0
