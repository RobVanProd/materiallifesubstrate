...
| `provenance.json` | source/parent identity, compiler, frozen inherited blobs, parent table hashes |
...
Metamorphic rows cover pair and local collective energy for translation,
proper rotation, rotation-plus-translation, half/double similarity, two packet
...
checkpoint bytes, source provenance, twin payload, manifest, and final
decision.
